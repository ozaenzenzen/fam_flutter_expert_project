...
void main() {
  ...
  testWidgets(
    'Page display when data is loaded',
    (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      whenListen(bloc, Stream.fromIterable([TopRatedMovieLoading(), TopRatedMovieError(message, retry: () {})]), initialState: TopRatedMovieInitial());
