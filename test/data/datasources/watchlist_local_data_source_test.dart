...
void main() {
  ...
  group('remove watchlist action', () {
    test('return success message when remove from database is success', () async {
      // arrange
      when(mockDatabaseHelper.removeWatchlist(
        testMovieTable.id,
        testMovieTable.dataType,
  ...
  group('Get Movie Detail By Id action', () {
    test('should return Movie Detail Table when data is found', () async {
      // arrange
      when(mockDatabaseHelper.getMovieById(
        testMovieTable.id,
        testMovieTable.dataType,
      )).thenAnswer((_) async => testMovieMap);
      // act
      final result = await dataSource.getMovieById(
        testMovieTable.id,
        testMovieTable.dataType,
      );
      // assert
